...
--
-- Struktur dari table `tbl_karyawan`
--

CREATE TABLE `tbl_karyawan` (
  `karyawan_id` int(11) NOT NULL AUTO_INCREMENT,
  `karyawan_nama` varchar(35) DEFAULT NULL,
  `karyawan_tempatlahir` varchar(30) DEFAULT NULL,
  `karyawan_tgllahir` date DEFAULT NULL,
  `karyawan_domisili` varchar(50) DEFAULT NULL,
  `karyawan_marrital` INTEGER(5) DEFAULT 1,
  `karyawan_status` BOOL DEFAULT 1,
  `karyawan_gender` INTEGER(5) DEFAULT 1,
...
(1, 'CV. Dua Sekawan', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '1'),
