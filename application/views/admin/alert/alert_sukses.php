   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="alert alert-success">
                    ...
                    <a class="btn btn-info" href="<?php echo base_url().'admin/Laporan/faktur_penjualan'?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
                </div>
            </div>
        </div>
        <!-- /.row -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by CV. Dua Sekawan</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
