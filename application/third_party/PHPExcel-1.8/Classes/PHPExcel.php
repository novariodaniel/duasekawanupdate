...
class PHPExcel
{
    ...
    */
    ...
    {
        // echo $this->getSheet($this->activeSheetIndex);die();
        // if ($this->activeSheetIndex < 0) {
        //     $this->activeSheetIndex = 0;
        // }
        // echo $this->activeSheetIndex;
        // echo $this->getSheet($this->activeSheetIndex);
    ...
    {                                
        if (!isset($this->workSheetCollection[$pIndex])) {
            ...
            // print_r($numSheets.''); die();           
            throw new PHPExcel_Exception(
                "Your requested sheet index: {$pIndex} is out of bounds. The actual number of sheets is {$numSheets}."
            );

        }    
        // print_r($this->workSheetCollection[$pIndex]);
    ...
    {                
        // print_r(count($this->workSheetCollection));        
